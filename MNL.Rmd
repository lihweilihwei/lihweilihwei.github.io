...
conclusion: M2 is the better model due to lower AIC, but if i were to include wait, i would take M4 due to how the p value when wait+ivvt is lower than in just wait. now we include person attributes too building upon M2
...
concession was not stated for SAAV though. now we try adding the other mode variables that we removed just now
...
conclusion: M11 is the best due to lowest AIC and highest proportion of significant coeffs. now we include person attributes too building upon M4

...
For example, the individual corresponding to the first row will choose the bus with a `r round(P[1,1]*100, 1)`% chance, Shared Bicycles/PMDs with a `r round(P[1,2]*100, 1)`% chance, and the SAAV with a `r round(P[1,3]*100, 1)`% chance.

...
Each row in the dataset corresponds to a choice task of a particular individual. We  randomly split the 125 individuals into the training or test set with a 70:30 ratio, while keeping all 8 choice tasks intact.
